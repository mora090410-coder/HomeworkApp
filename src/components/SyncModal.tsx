...
const SyncModal: React.FC<SyncModalProps> = ({ isOpen, onClose, exportData }) => {
  ...
  return (
    <div className="fixed inset-0 z-[3000] flex items-center justify-center p-4 font-sans text-neutral-black">
      ...
      <div className="relative w-full max-w-[480px] bg-white rounded-none shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-neutral-200">
        ...
        <div className="px-8 pt-10 pb-12 flex flex-col items-center relative z-10">
          <div className="text-center mb-8">
            ...
            <p className="text-neutral-500 text-sm">Transfer your family setup to another phone</p>
          </div>

          <div className="bg-white p-4 rounded-none border border-neutral-200 mb-8 shadow-sm">
            <img
              src={qrUrl}
              alt="Sync QR Code"
          ...
          <div className="w-full space-y-4">
            <div className="flex items-start gap-4 p-4 bg-neutral-50 border border-neutral-200 rounded-none">
              ...
              <div className="text-left pt-0.5">
                <p className="text-xs font-bold text-neutral-500 uppercase tracking-wider mb-0.5">Step 1</p>
            ...
            <div className="flex items-start gap-4 p-4 bg-neutral-50 border border-neutral-200 rounded-none">
              ...
              <div className="text-left pt-0.5">
                <p className="text-xs font-bold text-neutral-500 uppercase tracking-wider mb-0.5">Step 2</p>
