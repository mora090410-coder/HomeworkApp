                ...
                <main className="flex flex-col items-center text-center">
                    ...
                    <div className="flex flex-col items-center max-w-[800px] mb-20 px-4">
                        ...
                        <div className="flex flex-col items-center gap-6 w-full justify-center">
                            <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center">
                                <Link to="/signup" className="relative group overflow-hidden h-14 px-10 rounded-full bg-gradient-to-b from-primary-600 to-primary-700 text-white text-[16px] font-bold flex items-center justify-center gap-2 transition-all hover:scale-[1.05] active:scale-[0.98] shadow-[0_10px_30px_rgba(244,63,94,0.4)]">
                    ...
                    <section className="w-full mb-32">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-12">
                            {problemCards.map((card, idx) => (
                                <div key={idx} className="flex flex-col p-8 rounded-[32px] bg-white/[0.02] border border-white/10 text-left">
                    ...
                    <section className="w-full mb-32">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[900px] mx-auto">
                            {/* Pro Plan */}
                            <div className="relative p-10 rounded-[40px] bg-white/[0.03] border-2 border-primary-500/50 shadow-[0_24px_48px_rgba(244,63,94,0.15)] text-left">
                                <div className="absolute -top-4 left-1/2 -translate-x-1/2 rounded-full bg-primary-500 px-6 py-1.5 text-[11px] font-bold uppercase tracking-wider text-white">
                                    Most Popular
                                </div>
                                ...
                                <Link to="/signup" className="block w-full h-14 rounded-full bg-primary-500 text-white font-bold text-center leading-[56px] hover:bg-primary-600 transition-colors">Start Free Trial</Link>
                            </div>
                    ...
                    <section className="w-full mb-32 py-20 rounded-[48px] bg-gradient-to-b from-primary-600/10 to-transparent border border-white/5">
                        ...
                        <div className="flex flex-col items-center gap-6">
                            <Link to="/signup" className="h-16 px-12 rounded-full bg-primary-500 text-white text-lg font-bold flex items-center justify-center gap-3 transition-transform hover:scale-105 shadow-[0_20px_40px_rgba(244,63,94,0.3)]">
                                Start 14-Day Trial
