    ...
    <div className="bg-gray-50/50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/10 rounded-[16px] p-5 hover:bg-gray-100 dark:hover:bg-white/[0.04] transition-colors group relative overflow-visible">
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-start gap-2.5">
          ...
          <span className="text-[1.0625rem] font-[510] text-gray-900 dark:text-white leading-tight">
            {task.name}
          </span>
        </div>
        ...
        <div className="relative" ref={menuRef}>
          ...
          {isMenuOpen && (
            <div className="absolute right-0 top-full mt-2 w-48 glass-card border border-gray-200 dark:border-white/10 rounded-xl shadow-[0_12px_32px_rgba(0,0,0,0.5)] z-50 animate-in fade-in zoom-in-95 duration-200">
              <div className="p-1">
                <div className="relative">
                  <button
                    ...
                    className={`w-full text-left px-3 py-2.5 rounded-lg text-sm font-medium flex items-center justify-between gap-2 transition-colors cursor-pointer ${showAssignSubmenu ? 'bg-gray-100 dark:bg-white/10 text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white'}`}
                  >
                  ...
                  {showAssignSubmenu && (
                    <div
                      className="absolute left-full top-0 w-44 glass-card border border-gray-200 dark:border-white/10 rounded-xl shadow-2xl overflow-hidden z-[60] ml-1 animate-in slide-in-from-left-2 duration-200"
                    ...
                    >
                      {children.length > 0 ? children.map(child => (
                        <button
                          ...
                          className="w-full text-left px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white truncate cursor-pointer"
                        >
                          {child.name}
                        </button>
                      )) : (
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white flex items-center gap-2 cursor-pointer"
                >
